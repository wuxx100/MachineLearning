...
if __name__ == '__main__':
    path = 'findIODC/prn8.csv'
    data=pd.read_csv(path,header=None)
    pairParameter=[[13,12],[13,21],[13,18],[13,19],[12,21],[12,18],[12,19],[21,19],[21,19],[28,19]] ##这里用m0(13),deltaN(12),cis(21),toe(18),cic(19)  都试试
    featurePrime=np.array(data)
    feature=featurePrime[:,range(7,33)]
    feature = StandardScaler().fit_transform(feature)

    for [a,b] in pairParameter:
        print a, b
        feature1=feature[:,[a-7,b-7]]
