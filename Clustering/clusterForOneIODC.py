...
if __name__ == '__main__':
    ...
    readFolder = 'findIODC/cleanedData/'
    ...
    for fileName in files:
        if string.find(fileName, '.csv') != -1:
            ...
            data=pd.read_csv('findIODC/cleanedData/'+fileName,header=None)
            ...
            DBSCANModel = DBSCAN(eps=0.001, min_samples=2)
            ...
            resultData[range(1, 39)].to_csv('findIODC/Result/myNavMes.csv',mode='a',header=None,index=None)
            print
            plt.grid(True)
